...
pub use crate::stm32f4::peripherals::otg_hs_device_v1::{
    ...
    DOEPCTL1, DOEPCTL2, DOEPCTL3, DOEPCTL4, DOEPCTL5, DOEPEACHMSK1, DOEPINT0, DOEPINT1, DOEPINT2,
    DOEPINT3, DOEPINT4, DOEPINT5, DOEPINT6, DOEPINT7, DOEPMSK, DOEPTSIZ0, DOEPTSIZ1, DOEPTSIZ2,
    DOEPTSIZ3, DOEPTSIZ4, DOEPTSIZ5, DSTS, DTHRCTL, DTXFSTS0, DTXFSTS1, DTXFSTS2, DTXFSTS3,
    DTXFSTS4, DTXFSTS5, DVBUSDIS, DVBUSPULSE,
};
